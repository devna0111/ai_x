# http://localhost:5000/join?name=hong&age=32 (static Route)
# http://localhost:5000/join/hong/32 (Dynamic Route)
from flask import Flask, url_for

app = Flask(__name__)

# 라우팅 : URL을 특정 함수(뷰함수)에 연결하는 작업
...
if __name__ == "__main__" :
    # Flask가 http 요청 관련 정보를 활성화하여 정보 출력
